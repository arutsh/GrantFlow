...
- **Database**: new Alembic migration(s) adding `reports`, `report_lines`, `attachments`, `funding_receipts`, `currency_conversions` tables, plus new columns on `budgets` (`actual_currency`, `parent_budget_id`, `start_date`).
