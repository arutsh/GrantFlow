...
- [ ] 1.3 Confirm the `privacy@opengrantflow.com` mailbox/alias exists and forwards somewhere you monitor — do this before merging, since the policy will otherwise cite a dead address.
- [ ] 1.4 Run the frontend test suite and lint clean for the changed files; PR merged. (Tests + lint verified clean; PR not yet opened.)
